...
type QuizUploaderProps = {
  onUpload: (dataUri: string, language: string, numberOfQuestions: number) => void;
  isLoading: boolean;
};
...
export default function QuizUploader({ onUpload, isLoading }: QuizUploaderProps) {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      ...
      if (dataUri) {
        onUpload(dataUri, language, numberOfQuestions);
      } else {
        toast({
          variant: "destructive",
        ...
        <TabsContent value="upload" className="pt-6">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
              ...
              <div className="space-y-2">
                <Label htmlFor="questions-upload">Number of questions</Label>
                <Input
                  id="questions-upload"
                  type="number"
